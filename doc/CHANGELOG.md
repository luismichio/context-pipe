...
### Docs — README Vision, Ecosystem & Shadow MCP Registry
...
#### Changed
- **`pyproject.toml`**: `fail_under` raised 63 → 64.
...
### Phase 7.1 — pipe_run_dynamic (RAG for Pipes)
...
### Phase 7.2 — pipe_list_shadow_tools (Tool Discovery)
...
#### Changed
- **`pyproject.toml`**: `fail_under` raised 65 → 69.
...
#### Changed
- **`pyproject.toml`**: `fail_under` raised from 24 → 69 across multiple increments.
